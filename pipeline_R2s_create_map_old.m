function pipeline_R2s_create_map_old(opts)
%old version of pipeline_R2s_create_map
%new version calls separate fitting function (fit_R2s), so that fitting code can be used elsewhere
